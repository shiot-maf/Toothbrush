...
> = {
  grammar: { ko: "문법", color: "#e11d48", bg: "#ffe4e6" },
  vocabulary: { ko: "어휘", color: "#7c3aed", bg: "#ede9fe" },
  structure: { ko: "문장 구조", color: "#0891b2", bg: "#cffafe" },
  mechanics: { ko: "표기", color: "#65a30d", bg: "#ecfccb" },
}
